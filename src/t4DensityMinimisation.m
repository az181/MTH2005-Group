...
% a is 1/density at y=0, because this is 1/a+by^2 at y = 0.
% knowing a, we approximate b using 1/a+by = density at box.up.
...
% Upon obtaining our optimal parameters, calculating the estimated density for our y values.
